    ...
    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 pb-0">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground font-medium">
          Sales &amp; stock overview for <span className="text-foreground">{new Intl.DateTimeFormat('en-PH', { month: 'long', day: 'numeric', year: 'numeric', timeZone: 'Asia/Manila' }).format(new Date())}</span>.
        </p>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden lg:flex flex-col items-end">
            <p className="text-[9px] font-bold text-muted-foreground/50 uppercase tracking-widest leading-none mb-0.5">Store</p>
            <p className="text-[10px] font-extrabold text-emerald-500/80 leading-none">Open</p>
          </div>
